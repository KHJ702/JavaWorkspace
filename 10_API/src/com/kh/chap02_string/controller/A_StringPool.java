...
public class A_StringPool {
	...
	public void method1() {
		...
		System.out.println(str1.hashCode()); // (hashCode의 숫자값을) 상수풀의 주소값으로 사용
		System.out.println(str2.hashCode()); //-> 오버라이딩을 해서 hashCode 값이 같은거임
	...
	public void method2() {
		...
		// str1 == str2 //false
		System.out.println(str1 == str2); // true ==> 동일한 주소값에 데이터가 저장. (str2가 str1을 얕은 복사 했다고 생각)
	 ...
	 * 
	 * 단, 문자열 상수풀로드 감당이 불가능할 정도로 문자열 연산이 빈번한 경우, 문자열(String) 보다는
	 * 문자열 기반 가변클래스인 (StringBuilder, StringBuffer)를 사용하는 것을 권장.
	 * // 스캐너로 입력받은 문자들은 (문자열이 아닌 객체로 들어감)
	 * 
	 */
