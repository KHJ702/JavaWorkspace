...
public class A_UnchecledException {
	 ...
	 *  
	 *  => RuntimeException 계열들의 예외는 충분히 예측 가능한 에러들 이므로, 예외자체가
	...
	public void method3() {
		...
		System.out.println("100번 인덱스 "+arr[100]);
			...
			// 2개의 예외클래스를 1개의 예외클래스로 다루고자 할때? 부모타입 예외클래스 사용
	 ...
	 * 따라서, 애초에 예외가 발생하지 않도록 개발자가 소스코드를 핸들링 하는 것이 권장된다.
	 * 
