...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 *  - 계층구조를 보면 List, Set계열과 다른 Map계열 인터페이스만 상속한 클래스로, 사용하는 메서드가 다르다.
	...
	hm.put("꼬북칩", new Snack("콘소메맛",800));
	hm.put("프링클스", new Snack("짠맛",500));
	System.out.println(hm);

	hm.put("꼬북칩", new Snack("초코맛",1800)); // key값이 중복된 경우, 마지막 value로 덮어씌워짐.
