package com.kh.chap04_assist.part01_bufferedDao;
...
public class BufferedDao {
	 ...
	 *  
	 *  보조스트림 여러개 추가
	 *  보조스트림1 변수명 = new 보조스트림1(new보조스트림(기반스트림객체));
	 *  데코레이터패턴
	 *  
	 *  BufferedXXX : "속도 성능 향상" 목적의 보조스트림
	 *  => 데이터를 바로 출력/입력 하는 것이 아니라
	...
	public void fileSave() {
		...
		try (BufferedWriter bw = new BufferedWriter(new FileWriter("c_buffer.txt"));){ 
			...
			// 버퍼공간이 다 채워지지않은 상태에서 메서드가 종료될때, 버퍼에 담겨있는 데이터가 누락될 수 있으므르
